<h1> E01 — VisitaSalvador — Portal de Turismo </h1>
<h1> Portal Informativo - Desenvolvimento Front End I </h1>

<h1> Integrantes do Grupo: Alexandre Ferreira, Jailton de Morais, Rafael Vitor, Kauan Lobo, Erick Pablo e Messias Araújo </h1>
<h2> DESCRIÇÃO DO PROJETO </h2>
<p> Desenvolver um portal web completo sobre turismo em Salvador (BA), com pontos turísticos, cultura, gastronomia e eventos. O site deve ser semântico, responsivo e com design visual atrativo. </p> 

<h2> ENTREGAS OBRIGATÓRIAS POR UNIDADE </h2>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td> Documentação U1 (domínio/hospedagem) </td>
      <td> 10% </td>
    </tr>
  </tbody>
</table>
...
<ul>
  <li> <!DOCTYPE html> e estrutura HTML5 em TODOS os arquivos </li>
  <li> Meta charset UTF-8 e viewport em todas as páginas </li>
  <li> Mínimo 4 páginas HTML interligadas </li>
  <li> Arquivo CSS externo (nunca CSS inline ou <style> interno) </li>
  <li> Validação W3C: 0 erros críticos </li>
  <li> Relatório de domínio e hospedagem (U1) </li>
</ul>

<h2> TECNOLOGIAS OBRIGATÓRIAS </h2>
<ul>
  <li> HTML5 — semântica, acessibilidade, formulários </li>
...
<p> 10 min de apresentação + 5 min de perguntas por equipe </p>
